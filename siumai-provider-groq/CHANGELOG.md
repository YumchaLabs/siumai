...
## [0.11.0-beta.6](https://github.com/YumchaLabs/siumai/compare/siumai-provider-groq-v0.11.0-beta.5...siumai-provider-groq-v0.11.0-beta.6) - 2026-03-25

### Added

- *(v4)* align provider parity and typed metadata surfaces
- *(groq)* add config-first provider default options
