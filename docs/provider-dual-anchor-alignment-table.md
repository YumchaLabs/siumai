...
- Global audit checklist: `docs/provider-implementation-alignment.md`
- Backlog derived from the checklist: `docs/provider-implementation-backlog.md`
- Fixture-driven checklist: `docs/vercel-ai-fixtures-alignment.md`
- Core trio module map: `docs/core-trio-module-alignment.md`
