...
- Azure, DeepSeek, Vertex MaaS, Ollama, XAI, Bedrock, Anthropic, and Groq public-path registry
  setup use `RegistryBuilder` provider-level shortcuts rather than hand-written
