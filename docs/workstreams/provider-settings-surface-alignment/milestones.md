...
- The upstream OpenAI / Azure / Bedrock / Cohere / DeepSeek / TogetherAI / xAI / Groq / Mistral provider settings
...
- OpenAI, Azure, Bedrock, Cohere, DeepSeek, TogetherAI, xAI, Groq, and Mistral each expose a dedicated package-level
...
- `provider_ext::{deepseek,togetherai,xai,groq,mistral}::VERSION` now exist.
