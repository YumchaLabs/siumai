...
- The upstream OpenAI / Azure / Bedrock / Cohere / DeepSeek / TogetherAI / xAI provider settings
...
- OpenAI, Azure, Bedrock, Cohere, DeepSeek, TogetherAI, and xAI each expose a dedicated package-level
...
- `provider_ext::{deepseek,togetherai,xai}::VERSION` now exist.
