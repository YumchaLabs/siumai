...
- The upstream OpenAI / Azure / Bedrock / Cohere / DeepSeek / TogetherAI / xAI / Groq / Mistral / Perplexity / Fireworks / MoonshotAI provider settings
...
- OpenAI, Azure, Bedrock, Cohere, DeepSeek, TogetherAI, xAI, Groq, Mistral, Perplexity, Fireworks, and MoonshotAI each expose a dedicated package-level
...
- `provider_ext::{deepseek,togetherai,xai,groq,mistral,perplexity,fireworks,moonshotai}::VERSION` now exist.
