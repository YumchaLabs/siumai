...
- The upstream OpenAI / Azure / Bedrock / Cohere / DeepSeek / TogetherAI / xAI / Groq provider settings
...
- OpenAI, Azure, Bedrock, Cohere, DeepSeek, TogetherAI, xAI, and Groq each expose a dedicated package-level
...
- `provider_ext::{deepseek,togetherai,xai,groq}::VERSION` now exist.
