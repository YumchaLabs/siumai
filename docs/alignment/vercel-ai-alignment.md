...
- Transform: `siumai-core::streaming::transform_chat_event_stream` expands/filters events before encoding (useful for bridging/transcoding gateways).
...
- OpenAI Responses SSE serializer: expand stream part coverage (tool-input/tool-result, MCP, code interpreter, apply_patch, etc.).
...
- `docs/alignment/provider-granularity-alignment.md`
- `docs/alignment/provider-split-alignment.md`
- `docs/alignment/provider-implementation-alignment.md`
- `docs/alignment/provider-implementation-backlog.md`
- `docs/alignment/provider-dual-anchor-alignment-table.md`
