...
It complements `docs/alignment/provider-feature-alignment.md` (current state) by stating *where we want to go next*.
...
Checklist: `docs/alignment/m1-core-trio-checklist.md`
