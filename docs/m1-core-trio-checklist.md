...
This checklist operationalizes **M1** from `docs/provider-feature-targets.md`:
...
- [x] Provider-defined tool shape (`Tool::ProviderDefined`) + factories documented
  - Doc: `docs/provider-defined-tools-alignment.md`
...
- [x] Upstream fixture drift audit script
  ...
  - Doc entry: `docs/vercel-ai-fixtures-alignment.md`
