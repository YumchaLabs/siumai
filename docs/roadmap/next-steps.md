...
- `docs/architecture/public-surface.md` (recommended stable module paths for the `siumai` facade)
- `docs/alignment/provider-feature-alignment.md` (high-level provider feature matrix; use as refactor acceptance criteria)
- `docs/alignment/provider-feature-targets.md` (Alpha.5 target matrix; use as the prioritized roadmap)
