...
- `docs/m1-core-trio-checklist.md` (what is already covered by tests)
- `docs/provider-implementation-alignment.md` (global audit checklist across providers)
...
| Responses SSE serialization (gateway) | Vercel stream parts are internal to `@ai-sdk/provider` | `siumai-protocol-openai/src/standards/openai/responses_sse.rs` (`serialize_event`) | `siumai/tests/transcoding_*_to_openai_alignment_test.rs`, `docs/streaming-bridge-alignment.md` |
...
3. Update `docs/vercel-ai-fixtures-alignment.md` and this doc.
