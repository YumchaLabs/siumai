//! Ollama model-listing capability implementation.
//!
//! Implements remote model management functionality for Ollama.
...
/// Ollama model-listing capability implementation.
#[derive(Clone)]
pub struct OllamaModelListingCapability {
    pub base_url: String,
...
impl OllamaModelListingCapability {
    /// Creates a new Ollama model-listing capability.
    pub fn new(
        base_url: String,
...
#[async_trait]
impl ModelListingCapability for OllamaModelListingCapability {
