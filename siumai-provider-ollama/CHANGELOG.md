...
## [0.11.0-beta.6](https://github.com/YumchaLabs/siumai/compare/siumai-provider-ollama-v0.11.0-beta.5...siumai-provider-ollama-v0.11.0-beta.6) - 2026-03-25

### Added

- *(v4)* align provider parity and typed metadata surfaces
- *(ollama)* align builder helpers with config-first params
- *(providers)* align focused wrapper packages
- *(providers)* wire interceptors and middlewares from config
- *(provider)* config-first for ollama and groq
