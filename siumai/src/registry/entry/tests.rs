...
fn create_registry_with_defaults_registers_native_factories() {
    let _g = reg_test_guard();
    let reg = crate::registry::helpers::create_registry_with_defaults();
    ...
    #[cfg(feature = "openai")]
    {
        assert!(reg.language_model("openai:any-model").is_ok());
    }
    #[cfg(feature = "anthropic")]
    {
        assert!(reg.language_model("anthropic-vertex:any-model").is_ok());
    }
    #[cfg(feature = "google")]
    {
        assert!(reg.language_model("gemini:any-model").is_ok());
    }
    #[cfg(feature = "groq")]
    {
        assert!(reg.language_model("groq:any-model").is_ok());
    }
    #[cfg(feature = "xai")]
    {
        assert!(reg.language_model("xai:any-model").is_ok());
    }
    #[cfg(feature = "ollama")]
    {
        assert!(reg.language_model("ollama:any-model").is_ok());
    }
    #[cfg(feature = "minimaxi")]
    {
        assert!(reg.language_model("minimaxi:any-model").is_ok());
    }
}
