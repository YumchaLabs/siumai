...
pub mod prelude {
    ...
    pub mod unified {
        ...
        pub use siumai_core::types::{
            ...
            LanguageModelV4FunctionTool, LanguageModelV4ProviderTool, LanguageModelV4ToolChoice,
            ...
            last_assistant_message_is_complete_with_tool_calls, lazy_schema, prepare_tool_choice,
