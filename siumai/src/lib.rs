...
pub use siumai_core::utils::{
    ...
    StreamingToolCallTrackerOptions, StreamingToolCallTypeValidation, TypeValidationResult,
    VERSION, as_array, combine_headers, convert_base64_to_uint8_array,
    convert_image_model_file_to_data_uri, convert_to_base64, convert_uint8_array_to_base64,
    cosine_similarity, create_download, create_id_generator, download_url,
    ...
    parse_json, parse_json_with_schema, parse_provider_options, read_response_with_size_limit,
    remove_undefined_entries, resolve_provider_reference, safe_parse_json,
    safe_parse_json_with_schema, safe_validate_types, strip_file_extension, validate_download_url,
...
pub mod prelude {
    ...
    pub mod unified {
        ...
        pub use crate::{
            ...
            TypeValidationResult, VERSION, as_array, combine_headers,
            ...
            create_tool_name_mapping, download_url, extract_response_headers, filter_nullable,
            generate_id, get_error_message, get_runtime_environment_user_agent,
