...
pub mod prelude {
    ...
    pub mod unified {
        ...
        pub use siumai_core::types::{
            ...
            DynamicToolError, DynamicToolResult, Embedding, EmbeddingModelUsage, EmbeddingRequest,
            EmbeddingResponse, Experimental_GeneratedImage, Experimental_LanguageModelStreamPart,
            ExperimentalLanguageModelStreamPart, FileOutput, FilePart, FilePartSource,
            FinishReason, FlexibleSchema, GenerateImageRequest, GenerateTextContentPart,
            ...
            GenerateTextStepStartEvent, GeneratedFile, GeneratedImage, HttpConfig, ImageDetail,
            ...
            ModelMessageRole, OnChunkEvent, OnFinishEvent, OnStartEvent, OnStepFinishEvent,
            OnStepStartEvent, OnToolCallFinishEvent, OnToolCallStartEvent, OutputSchema,
            PrepareStepOptions, PrepareStepResult, Prompt, PromptExecutionError, PromptInput,
            ...
            ReasoningPart, RequestOptions, RerankRequest, RerankResponse, ResponseFormat,
            ResponseMessage, ResponseMetadata, Schema, SchemaValidator, Source,
            SpeechModelResponseMetadata, StandardizedPrompt, StaticToolCall, StaticToolError,
            StaticToolOutputDenied, StaticToolResult, StepResult, StopCondition,
            ...
            ToolResultOutput, ToolResultPart, TranscriptionModelResponseMetadata, TtsRequest,
            TtsResponse, TypedToolCall, TypedToolError, TypedToolOutputDenied, TypedToolResult,
            Usage, UserContent, UserContentPart, UserModelMessage, ValidationResult,
