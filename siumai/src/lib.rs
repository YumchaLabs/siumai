...
pub use siumai_core::utils::{
    ...
    LoadOptionalSettingOptions, LoadSettingOptions, ReasoningBudgetOptions, ReasoningLevel,
    ReasoningLevelConversionError, SerialJobExecutor, StreamingToolCallDelta,
    StreamingToolCallFunctionDelta, StreamingToolCallTracker, StreamingToolCallTrackerOptions,
    StreamingToolCallTypeValidation, TypeValidationResult, combine_headers,
    convert_image_model_file_to_data_uri, cosine_similarity, create_download, create_id_generator,
    download_url, extract_response_headers, filter_nullable, generate_id, get_text_from_data_url,
    inject_json_instruction, inject_json_instruction_into_messages, is_custom_reasoning,
    is_deep_equal_data, is_non_nullable, is_parsable_json, is_provider_reference, load_api_key,
...
pub mod prelude {
    ...
    pub mod unified {
        ...
        pub use crate::{
            ...
            StreamingToolCallTrackerOptions, StreamingToolCallTypeValidation, ToolNameMapping,
            TypeValidationResult, combine_headers, convert_image_model_file_to_data_uri,
            cosine_similarity, create_download, create_id_generator, create_tool_name_mapping,
            download_url, extract_response_headers, filter_nullable, generate_id,
            get_text_from_data_url, inject_json_instruction, inject_json_instruction_into_messages,
            is_custom_reasoning, is_deep_equal_data, is_non_nullable, is_parsable_json,
        ...
        pub use siumai_core::types::{
            ...
            NoSuchModelError, NoSuchModelType, NoSuchProviderError, NoSuchProviderReferenceError,
            ...
            OutputSchema, PrepareReconnectToStreamRequestOptions,
            ...
            ReasoningFilePart, ReasoningFileUIPart, ReasoningOutput, ReasoningPart,
            ReasoningUIPart, RequestCredentials, RequestOptions, RerankEndEvent, RerankRanking,
            ...
            RetryError, RetryErrorReason, Schema, SchemaValidator, Source, SourceDocumentUIPart,
            SourceUrlUIPart, SpeechModelResponseMetadata, SpeechResult, StandardizedPrompt,
            StaticToolCall, StaticToolError, StaticToolOutputDenied, StaticToolResult, StepResult,
            StepStartUIPart, StopCondition, StreamRequestOptions, StreamTextChunk,
            StreamTextChunkEvent, StreamTextLifecycleChunk, StreamTextLifecycleChunkType,
            SttRequest, SttResponse, SystemModelMessage, SystemPrompt, TelemetryOptions,
            TextOutput, TextPart, TextStreamAbortPart, TextStreamCustomPart, TextStreamErrorPart,
            TextStreamFilePart, TextStreamFinishPart, TextStreamFinishStepPart, TextStreamPart,
            TextStreamRawPart, TextStreamReasoningDeltaPart, TextStreamReasoningEndPart,
            TextStreamReasoningFilePart, TextStreamReasoningStartPart, TextStreamSourcePart,
            TextStreamStartPart, TextStreamStartStepPart, TextStreamTextDeltaPart,
            TextStreamTextEndPart, TextStreamTextStartPart, TextStreamToolApprovalRequestPart,
