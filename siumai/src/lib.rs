...
pub use siumai_core::utils::{
    ...
    as_array, combine_headers, convert_base64_to_uint8_array, convert_image_model_file_to_data_uri,
    convert_to_base64, convert_uint8_array_to_base64, cosine_similarity, create_download,
    create_id_generator, download_url, extract_response_headers, filter_nullable, generate_id,
...
pub mod prelude {
    ...
    pub mod unified {
        ...
        pub use crate::{
            ...
            TypeValidationResult, as_array, combine_headers, convert_base64_to_uint8_array,
