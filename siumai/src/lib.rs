...
pub mod prelude {
    ...
    pub mod unified {
        ...
        pub use siumai_core::types::{
            ...
            CompletionTokensDetails, ContentPart, Context, CustomOutput, CustomPart,
            CustomProviderOptions, DataContent, Embedding, EmbeddingModelUsage, EmbeddingRequest,
            EmbeddingResponse, FileOutput, FilePart, FilePartSource, FinishReason, FlexibleSchema,
            GenerateImageRequest, GenerateTextContentPart, GenerateTextModelInfo,
            GenerateTextReasoningPart, GenerateTextResponseMetadata, GenerateTextResult,
            GenerateTextStepReasoningPart, GenerateTextStepResult, GeneratedFile, GeneratedImage,
            ...
            LanguageModelUsage, LazySchema, MediaSource, MessageContent, MessageMetadata,
            MessageRole, MissingToolResultsError, ModelInfo, ModelMessage,
            ModelMessageConversionError, ModelMessageRole, OutputSchema, Prompt,
            ...
            SpeechModelResponseMetadata, StandardizedPrompt, StaticToolOutputDenied,
            ...
            ToolContent, ToolContentPart, ToolError, ToolModelMessage, ToolOutputDenied,
            ToolResult, ToolResultOutput, ToolResultPart, TranscriptionModelResponseMetadata,
            TtsRequest, TtsResponse, TypedToolOutputDenied, Usage, UserContent, UserContentPart,
