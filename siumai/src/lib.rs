...
pub mod prelude {
    ...
    pub mod unified {
        ...
        pub use siumai_core::types::{
            ...
            ChatRequest, ChatRequestBuilder, ChatRequestOptions, ChatResponse, ChatStatus,
            CommonParams, CompletionRequest, CompletionRequestOptions, CompletionResponse,
            CompletionStreamProtocol, CompletionTokensDetails, ContentPart, Context,
            CreateUIMessage, CustomOutput, CustomPart, CustomProviderOptions, DataContent,
            DefaultGeneratedFile, DynamicToolCall, DynamicToolError, DynamicToolResult,
            EmbedEndEvent, EmbedManyResult, EmbedOutput, EmbedResponseData, EmbedResult,
            EmbedStartEvent, EmbedValue, Embedding, EmbeddingModelCallEndEvent,
            ...
            GenerateVideoResult, GeneratedAudioFile, GeneratedFile, GeneratedImage, HttpConfig,
            ...
            InferUIDataParts, InvalidDataContentError, InvalidToolInputError, JSONSchema7,
            ...
            ModelMessageConversionError, ModelMessageRole, NoSuchToolError, ObjectStreamErrorPart,
            ...
            ReasoningPart, RequestCredentials, RequestOptions, RerankEndEvent, RerankRanking,
            RerankRankingEntry, RerankRequest, RerankResponse, RerankResponseMetadata,
            RerankResult, RerankStartEvent, RerankingModelCallEndEvent, RerankingModelCallRanking,
            RerankingModelCallStartEvent, ResponseFormat, ResponseMessage, ResponseMetadata,
            Schema, SchemaValidator, Source, SpeechModelResponseMetadata, SpeechResult,
            StandardizedPrompt, StaticToolCall, StaticToolError, StaticToolOutputDenied,
            StaticToolResult, StepResult, StopCondition, StreamRequestOptions, StreamTextChunk,
            StreamTextChunkEvent, StreamTextLifecycleChunk, StreamTextLifecycleChunkType,
            SttRequest, SttResponse, SystemModelMessage, SystemPrompt, TextOutput, TextPart,
            ...
            ToolCallRepairContext, ToolCallRepairError, ToolCallRepairFunctionError,
            ToolCallRepairResult, ToolChoice, ToolContent, ToolContentPart, ToolError,
            ToolExecutionEndEvent, ToolExecutionStartEvent, ToolModelMessage, ToolOutput,
            ToolOutputDenied, ToolResult, ToolResultOutput, ToolResultPart,
            TranscriptionModelResponseMetadata, TranscriptionResult, TranscriptionSegment,
            TtsRequest, TtsResponse, TypedToolCall, TypedToolError, TypedToolOutputDenied,
            TypedToolResult, UI_MESSAGE_STREAM_HEADERS, UIDataPartSchemas, UIDataTypesToSchemas,
            ...
            UiToolInvocationState, UiToolKind, UiToolPart, UiToolPartState, Usage,
