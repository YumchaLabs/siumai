...
pub mod prelude {
    ...
    pub mod unified {
        ...
        pub use siumai_core::types::{
            ...
            CompletionTokensDetails, ContentPart, CustomPart, CustomProviderOptions, DataContent,
            EmbeddingModelUsage, EmbeddingRequest, EmbeddingResponse, FilePart, FilePartSource,
            FinishReason, GenerateImageRequest, GeneratedImage, HttpConfig, ImageDetail,
            ImageGenerationRequest, ImageGenerationResponse, ImageModelProviderMetadata,
            ImageModelResponseMetadata, ImageModelUsage, ImagePart, JSONValue,
            ...
            PromptValidationError, ProviderDefinedTool, ProviderMetadata, ProviderOptionsMap,
            ProviderReference, ProviderType, ReasoningFilePart, ReasoningPart, RequestOptions,
            RerankRequest, RerankResponse, ResponseFormat, ResponseMetadata, SchemaValidator,
            SpeechModelResponseMetadata, StandardizedPrompt, StreamRequestOptions, SttRequest,
            SttResponse, SystemModelMessage, SystemPrompt, TextPart, TimeoutConfiguration,
            TimeoutConfigurationSettings, Tool, ToolApprovalRequest, ToolApprovalResponse,
            ToolCallPart, ToolChoice, ToolContent, ToolContentPart, ToolModelMessage,
