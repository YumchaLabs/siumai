...
pub mod prelude {
    ...
    pub mod unified {
        ...
        pub use siumai_core::types::{
            ...
            CacheControl, CallSettings, CallWarning, CallbackModelInfo, CancelHandle, ChatMessage,
            ChatRequest, ChatRequestBuilder, ChatResponse, CommonParams, CompletionRequest,
            CompletionResponse, CompletionTokensDetails, ContentPart, Context, CustomOutput,
            CustomPart, CustomProviderOptions, DataContent, DefaultGeneratedFile, DynamicToolCall,
            DynamicToolError, DynamicToolResult, EmbedEndEvent, EmbedManyResult, EmbedOutput,
            EmbedResponseData, EmbedResult, EmbedStartEvent, EmbedValue, Embedding,
            EmbeddingModelCallEndEvent, EmbeddingModelCallStartEvent, EmbeddingModelUsage,
            EmbeddingRequest, EmbeddingResponse, Experimental_GenerateImageResult,
            Experimental_GeneratedImage, Experimental_LanguageModelStreamPart,
            Experimental_SpeechResult, Experimental_TranscriptionResult,
            ExperimentalLanguageModelStreamPart, FileOutput, FilePart, FilePartSource,
            FinishReason, FlexibleSchema, GenerateImageRequest, GenerateImageResult,
            GenerateObjectEndEvent, GenerateObjectOutputStrategy, GenerateObjectResponseMetadata,
            GenerateObjectStartEvent, GenerateObjectStepEndEvent, GenerateObjectStepStartEvent,
            GenerateTextContentPart, GenerateTextEndEvent, GenerateTextModelInfo,
            GenerateTextReasoningPart, GenerateTextResponseMetadata, GenerateTextResult,
            GenerateTextStartEvent, GenerateTextStepEndEvent, GenerateTextStepReasoningPart,
            GenerateTextStepResult, GenerateTextStepStartEvent, GenerateVideoResult,
            GeneratedAudioFile, GeneratedFile, GeneratedImage, HttpConfig, ImageDetail,
            ImageGenerationRequest, ImageGenerationResponse, ImageModelProviderMetadata,
            ImageModelResponseMetadata, ImageModelUsage, ImagePart, InvalidDataContentError,
            JSONSchema7, JSONValue, LanguageModelCallOptions, LanguageModelInputTokenDetails,
            ...
            LazySchema, MediaSource, MessageContent, MessageMetadata, MessageRole,
            MissingToolResultsError, ModelCallResponseData, ModelInfo, ModelMessage,
            ModelMessageConversionError, ModelMessageRole, ObjectStreamErrorPart,
            ObjectStreamFinishPart, ObjectStreamObjectPart, ObjectStreamPart,
            ObjectStreamTextDeltaPart, OnChunkEvent, OnFinishEvent, OnStartEvent,
            OnStepFinishEvent, OnStepStartEvent, OnToolCallFinishEvent, OnToolCallStartEvent,
            OutputSchema, PrepareStepOptions, PrepareStepResult, Prompt, PromptExecutionError,
            PromptInput, PromptTokensDetails, PromptValidationError, ProviderDefinedTool,
            ProviderMetadata, ProviderOptions, ProviderOptionsMap, ProviderReference, ProviderType,
            PruneEmptyMessagesMode, PruneMessagesOptions, PruneReasoningMode, PruneToolCallMode,
            PruneToolCallRule, ReasoningFileOutput, ReasoningFilePart, ReasoningOutput,
            ReasoningPart, RequestOptions, RerankEndEvent, RerankRanking, RerankRankingEntry,
            ...
            ResponseFormat, ResponseMessage, ResponseMetadata, Schema, SchemaValidator, Source,
            SpeechModelResponseMetadata, SpeechResult, StandardizedPrompt, StaticToolCall,
            StaticToolError, StaticToolOutputDenied, StaticToolResult, StepResult, StopCondition,
            StreamRequestOptions, StreamTextChunk, StreamTextChunkEvent, StreamTextLifecycleChunk,
            StreamTextLifecycleChunkType, SttRequest, SttResponse, SystemModelMessage,
            SystemPrompt, TextOutput, TextPart, TextStreamAbortPart, TextStreamCustomPart,
            TextStreamErrorPart, TextStreamFilePart, TextStreamFinishPart,
            TextStreamFinishStepPart, TextStreamPart, TextStreamRawPart,
            ...
            TextStreamToolOutputDeniedPart, TextStreamToolResultPart, TimeoutConfiguration,
            TimeoutConfigurationSettings, Tool, ToolApprovalConfiguration,
            ToolApprovalDecisionContext, ToolApprovalRequest, ToolApprovalRequestOutput,
            ToolApprovalResponse, ToolApprovalResponseOutput, ToolApprovalStatus,
            ToolApprovalStatusDetails, ToolApprovalStatusType, ToolCall, ToolCallPart,
            ToolCallRepairContext, ToolCallRepairError, ToolCallRepairResult, ToolChoice,
            ...
            ToolResultOutput, ToolResultPart, TranscriptionModelResponseMetadata,
            TranscriptionResult, TranscriptionSegment, TtsRequest, TtsResponse, TypedToolCall,
            TypedToolError, TypedToolOutputDenied, TypedToolResult, UI_MESSAGE_STREAM_HEADERS,
            UIMessageStreamOptions, UiCustomPart, UiDataPart, UiFilePart, UiMessage,
            UiMessageAbortChunk, UiMessageChunk, UiMessageCustomChunk, UiMessageDataChunk,
            UiMessageErrorChunk, UiMessageFileChunk, UiMessageFinishChunk,
            UiMessageFinishStepChunk, UiMessageMetadataChunk, UiMessagePart,
            ...
            UiMessageToolOutputDeniedChunk, UiMessageToolOutputErrorChunk, UiPartState,
            UiProviderMetadata, UiReasoningFilePart, UiReasoningPart, UiSourceDocumentPart,
            UiSourceUrlPart, UiTextPart, UiToolApproval, UiToolApprovalDecision,
            UiToolApprovalRequest, UiToolApprovedApproval, UiToolDeniedApproval, UiToolInvocation,
            UiToolInvocationState, UiToolKind, UiToolPart, UiToolPartState, Usage, UserContent,
            ...
            as_schema, as_schema_or_empty, convert_data_content_to_base64_string,
            create_null_language_model_usage, empty_json_schema, experimental_filter_active_tools,
            filter_active_tools, get_chunk_timeout_ms, get_step_timeout_ms, get_tool_timeout_ms,
            get_total_timeout_ms, has_tool_call, is_loop_finished, is_step_count,
            is_stop_condition_met, json_schema, json_schema_with_validator, lazy_schema,
