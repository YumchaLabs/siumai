...
impl SiumaiBuilder {
    ...
    pub fn siliconflow(mut self) -> Self {
        ...
        self.provider_id = Some("siliconflow".to_string());
        self
    }
    ...
    pub fn deepseek(mut self) -> Self {
        ...
        self.provider_id = Some("deepseek".to_string());
        self
    }
    ...
    pub fn openrouter(mut self) -> Self {
        ...
        self.provider_id = Some("openrouter".to_string());
        self
    }
    ...
    pub fn together(mut self) -> Self {
        ...
        self.provider_id = Some("together".to_string());
        self
    }
    ...
    pub fn fireworks(mut self) -> Self {
        ...
        self.provider_id = Some("fireworks".to_string());
        self
    }
    ...
    pub fn github_copilot(mut self) -> Self {
        ...
        self.provider_id = Some("github_copilot".to_string());
        self
    }
    ...
    pub fn perplexity(mut self) -> Self {
        ...
        self.provider_id = Some("perplexity".to_string());
        self
    }
    ...
    pub fn mistral(mut self) -> Self {
        ...
        self.provider_id = Some("mistral".to_string());
        self
    }
    ...
    pub fn cohere(mut self) -> Self {
        ...
        self.provider_id = Some("cohere".to_string());
        self
    }
    ...
    pub fn zhipu(mut self) -> Self {
        ...
        self.provider_id = Some("zhipu".to_string());
        self
    }
    ...
    pub fn moonshot(mut self) -> Self {
        ...
        self.provider_id = Some("moonshot".to_string());
        self
    }
    ...
    pub fn doubao(mut self) -> Self {
        ...
        self.provider_id = Some("doubao".to_string());
        self
    }
    ...
    pub fn qwen(mut self) -> Self {
        ...
        self.provider_id = Some("qwen".to_string());
        self
    }
    ...
    pub fn yi(mut self) -> Self {
        ...
        self.provider_id = Some("yi".to_string());
        self
    }
    ...
    pub fn baichuan(mut self) -> Self {
        ...
        self.provider_id = Some("baichuan".to_string());
        self
    }
    ...
    pub fn groq_openai_compatible(mut self) -> Self {
        ...
        self.provider_id = Some("groq_openai_compatible".to_string());
        self
    }
    ...
    pub fn xai_openai_compatible(mut self) -> Self {
        ...
        self.provider_id = Some("xai_openai_compatible".to_string());
        self
    }
    ...
    pub fn nvidia(mut self) -> Self {
        ...
        self.provider_id = Some("nvidia".to_string());
        self
    }
    ...
    pub fn hyperbolic(mut self) -> Self {
        ...
        self.provider_id = Some("hyperbolic".to_string());
        self
    }
    ...
    pub fn jina(mut self) -> Self {
        ...
        self.provider_id = Some("jina".to_string());
        self
    }
    ...
    pub fn github(mut self) -> Self {
        ...
        self.provider_id = Some("github".to_string());
        self
    }
    ...
    pub fn voyageai(mut self) -> Self {
        ...
        self.provider_id = Some("voyageai".to_string());
        self
    }
    ...
    pub fn poe(mut self) -> Self {
        ...
        self.provider_id = Some("poe".to_string());
        self
    }
    ...
    pub fn stepfun(mut self) -> Self {
        ...
        self.provider_id = Some("stepfun".to_string());
        self
    }
    ...
    pub fn minimax(mut self) -> Self {
        ...
        self.provider_id = Some("minimax".to_string());
        self
    }
    ...
    pub fn infini(mut self) -> Self {
        ...
        self.provider_id = Some("infini".to_string());
        self
    }
    ...
    pub fn modelscope(mut self) -> Self {
        ...
        self.provider_id = Some("modelscope".to_string());
        self
    }
    ...
    pub fn hunyuan(mut self) -> Self {
        ...
        self.provider_id = Some("hunyuan".to_string());
        self
    }
    ...
    pub fn baidu_cloud(mut self) -> Self {
        ...
        self.provider_id = Some("baidu_cloud".to_string());
        self
    }
    ...
    pub fn tencent_cloud_ti(mut self) -> Self {
        ...
        self.provider_id = Some("tencent_cloud_ti".to_string());
        self
    }
    ...
    pub fn xirang(mut self) -> Self {
        ...
        self.provider_id = Some("xirang".to_string());
        self
    }
    ...
    pub fn ai302(mut self) -> Self {
        ...
        self.provider_id = Some("302ai".to_string());
        self
    }
    ...
    pub fn aihubmix(mut self) -> Self {
        ...
        self.provider_id = Some("aihubmix".to_string());
        self
    }
    ...
    pub fn ppio(mut self) -> Self {
        ...
        self.provider_id = Some("ppio".to_string());
        self
    }
    ...
    pub fn ocoolai(mut self) -> Self {
        ...
        self.provider_id = Some("ocoolai".to_string());
        self
    }
}
