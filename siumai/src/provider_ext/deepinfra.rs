...
/// [`create_deepinfra()`], [`crate::compat::Provider::deepinfra()`], or
/// [`SiumaiBuilder::deepinfra()`].
...
pub fn deepinfra() -> SiumaiBuilder {
    SiumaiBuilder::new().deepinfra()
}

/// Create the unified DeepInfra provider builder.
///
/// This is the Rust package-surface analogue of AI SDK `createDeepInfra()`.
pub fn create_deepinfra() -> SiumaiBuilder {
    deepinfra()
}
