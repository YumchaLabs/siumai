...
fn public_surface_unified_imports_compile() {
    ...
    let _ = size_of::<LanguageModelV4CallOptions>();
    let _ = size_of::<LanguageModelV4Content>();
    let _ = size_of::<LanguageModelV4CustomContent>();
    let _ = size_of::<LanguageModelV4CustomPart>();
    let _ = size_of::<LanguageModelV4DataContent>();
    let _ = size_of::<LanguageModelV4File>();
    let _ = size_of::<LanguageModelV4FilePart>();
    ...
    let _ = size_of::<LanguageModelV4Message>();
    let _ = size_of::<LanguageModelV4OutputTokens>();
    let _ = size_of::<LanguageModelV4Prompt>();
    let _ = size_of::<LanguageModelV4ProviderTool>();
    let _ = size_of::<LanguageModelV4Reasoning>();
    let _ = size_of::<LanguageModelV4ReasoningFile>();
    let _ = size_of::<LanguageModelV4ReasoningFilePart>();
    let _ = size_of::<LanguageModelV4ReasoningPart>();
    let _ = size_of::<LanguageModelV4RequestMetadata>();
    let _ = size_of::<LanguageModelV4ResponseMetadata>();
    let _ = size_of::<LanguageModelV4Source>();
    let _ = size_of::<LanguageModelV4StreamResponseMetadata>();
    let _ = size_of::<LanguageModelV4StreamResult>();
    let _ = size_of::<LanguageModelV4SystemMessage>();
    let _ = size_of::<LanguageModelV4Text>();
    let _ = size_of::<LanguageModelV4TextPart>();
    let _ = size_of::<LanguageModelV4Tool>();
    let _ = size_of::<LanguageModelV4ToolApprovalRequest>();
    let _ = size_of::<LanguageModelV4ToolApprovalResponsePart>();
    let _ = size_of::<LanguageModelV4ToolCall>();
    let _ = size_of::<LanguageModelV4ToolCallPart>();
    ...
    let _ = size_of::<LanguageModelV4UserMessage>();
    let _ = prepare_language_model_v4_prompt(Vec::<ModelMessage>::new());
...
fn registry_handles_compile_as_family_models() {
    ...
    use siumai::image::{ImageModel, ImageModelV4};
    ...
    fn _assert_image_handle<T: ImageModel + ImageModelV4 + ModelMetadata>() {}
...
fn public_surface_streaming_aliases_compile() {
    use siumai::experimental::streaming::{
        LanguageModelV4StreamFile, LanguageModelV4StreamFinishReason, LanguageModelV4StreamPart,
        LanguageModelV4StreamToolCall, LanguageModelV4StreamUsage, SharedV4ProviderMetadata,
        SharedV4Warning, TypedStreamPart,
    };

    let _ = size_of::<TypedStreamPart>();
