...
fn run_case(root: &Path) {
    ...
    let standard = siumai::experimental::standards::cohere::rerank::CohereRerankStandard::new();
    let transformers = standard.create_transformers("cohere");
    ...
    let spec = standard.create_spec("cohere");
...
#[test]
fn cohere_rerank_fixtures_match() {
