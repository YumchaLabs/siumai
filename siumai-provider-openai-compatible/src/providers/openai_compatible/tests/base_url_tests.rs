...
mod tests {
    ...
    fn test_base_url_method_exists() {
        ...
        let openai_compatible_builder =
            OpenAiCompatibleBuilder::new(BuilderBase::default(), "deepseek");
    ...
    fn test_base_url_accepts_string_types() {
        ...
        let _result2 =
            OpenAiCompatibleBuilder::new(BuilderBase::default(), "deepseek").base_url(url);

        // &str
        let url_ref = "https://example.com/v1";
        let _result3 =
            OpenAiCompatibleBuilder::new(BuilderBase::default(), "deepseek").base_url(url_ref);
    }
    ...
    fn test_base_url_with_trailing_slash() {
        ...
        let _result = OpenAiCompatibleBuilder::new(BuilderBase::default(), "deepseek")
            .base_url("https://example.com/v1/");
    ...
    fn test_base_url_with_different_protocols() {
        ...
        let _result2 = OpenAiCompatibleBuilder::new(BuilderBase::default(), "deepseek")
