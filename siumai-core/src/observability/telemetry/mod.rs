//! Telemetry Module - External Event Export (observability)
//!
//! Moved from `crate::telemetry` to `crate::observability::telemetry`.
//! Exports structured events to external platforms like Langfuse/Helicone.
