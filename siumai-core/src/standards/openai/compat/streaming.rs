...
mod tests {
    use super::*;
    use crate::standards::openai::compat::provider_registry::{ConfigurableAdapter, ProviderConfig, ProviderFieldMappings};
    use crate::streaming::SseEventConverter;
    ...
    async fn deepseek_streaming_emits_usage_then_single_stream_end_and_ignores_done() {
        let adapter = Arc::new(ConfigurableAdapter::new(ProviderConfig {
            ...
            capabilities: vec!["tools".to_string(), "vision".to_string(), "reasoning".to_string()],
