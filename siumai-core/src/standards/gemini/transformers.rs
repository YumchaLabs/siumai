    ...
    fn transform_chat(&self, req: &ChatRequest) -> Result<serde_json::Value, LlmError> {
        ...
        impl ProviderRequestHooks for GeminiChatHooks {
            ...
            fn post_process_chat(
                ...
                if let crate::types::ProviderOptions::Gemini(opts) = &req.provider_options {
                            ...
                            if is_gemini_2_or_newer(model) {
                                    ...
                                    && let Some(cfg) = &search.dynamic_retrieval_config
                                {
                                    let mode = match cfg.mode {
                                        crate::types::provider_options::gemini::DynamicRetrievalMode::ModeDynamic => "MODE_DYNAMIC",
                                        crate::types::provider_options::gemini::DynamicRetrievalMode::ModeUnspecified => "MODE_UNSPECIFIED",
                                    };
...
mod tests_gemini_rules {
    ...
    fn provider_options_cached_content_is_mapped() {
        ...
        let req = req.with_gemini_options(
            crate::types::GeminiOptions::new().with_cached_content("cachedContents/test-123"),
        );
    ...
    fn provider_options_generation_config_fields_are_mapped() {
        use crate::types::provider_options::gemini::{
            GeminiResponseModality, GeminiThinkingConfig,
        };
    ...
    fn provider_options_response_mime_type_is_mapped_to_generation_config() {
        ...
        let req = req.with_gemini_options(
            crate::types::GeminiOptions::new().with_response_mime_type("application/json"),
        );
    ...
    fn provider_options_serialization_locations_and_casing_are_stable() {
        ...
        use crate::types::{GeminiResponseModality, GeminiThinkingConfig};
        use std::collections::HashMap;
