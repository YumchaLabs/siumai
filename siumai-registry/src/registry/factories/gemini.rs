...
impl ProviderFactory for GeminiProviderFactory {
    ...
    async fn speech_model_with_ctx(
        ...
        Err(LlmError::UnsupportedOperation(
            "Gemini does not currently expose a provider-owned speech family path".to_string(),
        ))
    }
    ...
    async fn transcription_model_with_ctx(
        ...
        Err(LlmError::UnsupportedOperation(
            "Gemini does not currently expose a provider-owned transcription family path"
                .to_string(),
        ))
    }
