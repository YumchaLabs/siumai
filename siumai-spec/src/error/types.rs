        ...
        match self {
            ...
            Self::NoObjectGenerated { .. } => {
                vec![
                    ...
                    "Retry with stronger JSON/schema instructions or a stricter response format".to_string(),
                    "Provide a repair callback when the provider frequently returns near-valid JSON".to_string(),
                ]
            }
            _ => vec![
