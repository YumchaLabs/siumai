...
//!
//! OpenAI provider implementation + shared OpenAI-like protocol standard.
//!
//! This crate owns:
...
//! - the shared OpenAI-like protocol mapping and streaming/tool-call helpers used by multiple providers
#![deny(unsafe_code)]
